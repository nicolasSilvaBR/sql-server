...
-- PRECEDING ARE INCLUSIVE

SELECT
    OrderYear,
    OrderMonth,   
    SubTotal,
    Rolling3MonthTotal = SUM(SubTotal) OVER (PARTITION BY OrderYear ORDER BY OrderYear, OrderMonth ROWS BETWEEN 2 PRECEDING AND CURRENT ROW),
